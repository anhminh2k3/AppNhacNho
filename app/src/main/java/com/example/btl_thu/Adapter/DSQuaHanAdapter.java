...
public class DSQuaHanAdapter extends ArrayAdapter<ListLoiNhac> {
    private Context context;
    private List<ListDS> lsDS;
    private List<ListLoiNhac> lsLoiNhac;
    private sqlite sql;
    public DSQuaHanAdapter(@NonNull Context context, List<ListLoiNhac> lsLoiNhac ,@NonNull List<ListDS> lsDS) {
...
//        if (position < lsDSanh.size()) {
        ...
        List<ListLoiNhac> loiNhacList = sql.getLoiNhacByDSIDQuaHan(id);
